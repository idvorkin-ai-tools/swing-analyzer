...
import { isLandscapeVideo } from './utils/videoLoadingUtils';
...
export function useExerciseAnalyzer(_initialState?: Partial<AppState>) {
  ...
  const {
    ...
    pipelineRef,
    actions: {
      setRepCount: actions.setRepCount,
      clearThumbnails: actions.clearThumbnails,
      setStatus: actions.setStatus,
      startLoading: actions.startLoading,
      setLoadingProgress: actions.setLoadingProgress,
      videoLoaded: actions.videoLoaded,
      error: actions.error,
    },
    syncCanvasToVideo,
    resetDetectionState,
  ...
  }, [currentVideoUrlRef, videoLoadAbortControllerRef]);
